                    ...
                    GIF = (function(superClass) {
                        ...
                        GIF.prototype.render = function() {
                            ...
                            this.imageParts = function() {
                                ...
                                results = [];
                                for (
                                    i = j = 0, ref = this.frames.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j
                                ) {
                                    results.push(null);
                                }
                                return results;
                            ...
                            if (this.options.globalPalette === true) {
                                ...
                                for (
                                    i = j = 0, ref = numWorkers; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j
                                ) {
                                    this.renderNextFrame();
                                }
                            }
                        ...
                        GIF.prototype.spawnWorkers = function() {
                            ...
                            (function() {
                                    results = [];
                                    for (
                                        var j = (ref = this.freeWorkers.length); ref <= numWorkers ? j < numWorkers : j > numWorkers; ref <= numWorkers ? j++ : j--
                                    ) {
                                        results.push(j);
                                    }
                                    return results;
                        ...
                        GIF.prototype.frameFinished = function(frame) {
                            ...
                            if (this.options.globalPalette === true) {
                                ...
                                if (this.frames.length > 2) {
                                    for (
                                        i = j = 1, ref = this.freeWorkers.length; 1 <= ref ? j < ref : j > ref; i = 1 <= ref ? ++j : --j
                                    ) {
                                        this.renderNextFrame();
                                    }
                                }
