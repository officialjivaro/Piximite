...
! function(t) {
    ...
    P.cleanData = (o = P.cleanData, function(t) {
        for (var e, i, s = 0; null != (i = t[s]); s++)(e = P._data(i, "events")) && e.remove && P(i).triggerHandler("remove");
        o(t)
    }), P.widget = function(t, i, e) {
        var s, o, n, r = {},
            h = t.split(".")[0],
            a = h + "-" + (t = t.split(".")[1]);
        return e || (e = i, i = P.Widget), Array.isArray(e) && (e = P.extend.apply(null, [{}].concat(e))), P.expr.pseudos[a.toLowerCase()] = function(t) {
            return !!P.data(t, a)
        }, P[h] = P[h] || {}, s = P[h][t], o = P[h][t] = function(t, e) {
            ...
            _proto: P.extend({}, e),
            _childConstructors: []
        }), (n = new i).options = P.widget.extend({}, n.options), P.each(e, function(e, s) {
            function o() {
        ...
        }), delete s._childConstructors) : i._childConstructors.push(o), P.widget.bridge(t, o), o
    }, P.widget.extend = function(t) {
        for (var e, i, s = h.call(arguments, 1), o = 0, n = s.length; o < n; o++)
            for (e in s[o]) i = s[o][e], r.call(s[o], e) && void 0 !== i && (P.isPlainObject(i) ? t[e] = P.isPlainObject(t[e]) ? P.widget.extend({}, t[e], i) : P.widget.extend({}, i) : t[e] = i);
        return t
        ...
        P.fn[n] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                return "instance" === i ? (o = e, !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? P.error("no such method '" + i + "' for " + n + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t, !1) : void 0 : P.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : o = void 0 : (s.length && (i = P.widget.extend.apply(null, [i].concat(s))), this.each(function() {
                var t = P.data(this, r);
                t ? (t.option(i || {}), t._init && t._init()) : P.data(this, r, new e(i, this))
            })), o
        }
        ...
        _createWidget: function(t, e) {
            e = P(e || this.defaultElement || this)[0], this.element = P(e), this.uuid = i++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = P(), this.hoverable = P(), this.focusable = P(), this.classesElementLookup = {}, e !== this && (P.data(e, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(t) {
                    t.target === e && this.destroy()
                }
            }), this.document = P(e.style ? e.ownerDocument : e.document || e), this.window = P(this.document[0].defaultView || this.document[0].parentWindow)), this.options = P.widget.extend({}, this.options, this._getCreateOptions(), t), this._create(), this.options.disabled && this._setOptionDisabled(this.options.disabled), this._trigger("create", null, this._getCreateEventData()), this._init()
        },
        ...
        destroy: function() {
            var i = this;
            this._destroy(), P.each(this.classesElementLookup, function(t, e) {
                i._removeClass(e, t)
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                if (n = {}, t = (i = t.split(".")).shift(), i.length) {
                    for (s = n[t] = P.widget.extend({}, this.options[t]), o = 0; o < i.length - 1; o++) s[i[o]] = s[i[o]] || {}, s = s[i[o]];
        ...
        _setOptionClasses: function(t) {
            var e, i, s;
            for (e in t) s = this.classesElementLookup[e], t[e] !== this.options.classes[e] && s && s.length && (i = P(s.get()), this._removeClass(s, e), i.addClass(this._classes({
                element: i,
                keys: e,
                classes: t,
                add: !0
        ...
        _classes: function(o) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++) i = r.classesElementLookup[t[s]] || P(), i = o.add ? (function() {
                    var i = [];
                    o.element.each(function(t, e) {
                        P.map(r.classesElementLookup, function(t) {
                            return t
                        }).some(function(t) {
                            return t.is(e)
                        }) || i.push(e)
                ...
                }(), P(P.uniqueSort(i.get().concat(o.element.get())))) : P(i.not(o.element).get()), r.classesElementLookup[t[s]] = i, n.push(t[s]), e && o.classes[t[s]] && n.push(o.classes[t[s]])
            }
            return (o = P.extend({
        ...
        _on: function(o, n, t) {
            var r, h = this;
            "boolean" != typeof o && (t = n, n = o, o = !1), t ? (n = r = P(n), this.bindings = this.bindings.add(n)) : (t = n, n = this.element, r = this.widget()), P.each(t, function(t, e) {
                function i() {
        ...
        _off: function(t, e) {
            e = (e || "").split(" ").join(this.eventNamespace + " ") + this.eventNamespace, t.off(e), this.bindings = P(this.bindings.not(t).get()), this.focusable = P(this.focusable.not(t).get()), this.hoverable = P(this.hoverable.not(t).get())
        },
        _delay: function(t, e) {
            var i = this;
        ...
        _trigger: function(t, e, i) {
            ...
            if (i = i || {}, (e = P.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], o = e.originalEvent)
        ...
        P.Widget.prototype["_" + n] = function(e, t, i) {
            ...
            "number" == typeof(t = t || {}) ? t = {
                duration: t
            }: !0 === t && (t = {}), s = !P.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && P.effects && P.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function(t) {
                P(this)[n](), i && i.call(e[0]), t()
            })
        }
    });
    var s, x, z, n, a, l, c, p, C;
    P.widget;
    ...
    x = Math.max, z = Math.abs, n = /left|center|right/, a = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/, C = P.fn.position, P.position = {
        scrollbarWidth: function() {
            if (void 0 !== s) return s;
            var t, e = P("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>"),
                i = e.children()[0];
            return P("body").append(e), t = i.offsetWidth, e.css("overflow", "scroll"), t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(), s = t - i
        },
        ...
        var f, d, u, g, m, t, _ = "string" == typeof(p = P.extend({}, p)).of ? P(document).find(p.of) : P(p.of),
            v = P.position.getWithinInfo(p.within),
            w = P.position.getScrollInfo(v),
        ...
        return _[0].preventDefault && (p.at = "left top"), d = e.width, u = e.height, m = P.extend({}, g = e.offset), P.each(["my", "at"], function() {
            var t, e, i = (p[this] || "").split(" ");
            (i = 1 === i.length ? n.test(i[0]) ? i.concat(["center"]) : a.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = n.test(i[0]) ? i[0] : "center", i[1] = a.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), y[this] = [t ? t[0] : 0, e ? e[0] : 0], p[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
        }), 1 === b.length && (b[1] = b[0]), "right" === p.at[0] ? m.left += d : "center" === p.at[0] && (m.left += d / 2), "bottom" === p.at[1] ? m.top += u : "center" === p.at[1] && (m.top += u / 2), f = H(y.at, d, u), m.left += f[0], m.top += f[1], this.each(function() {
            var i, t, r = P(this),
                h = r.outerWidth(),
                a = r.outerHeight(),
                e = I(this, "marginLeft"),
                s = I(this, "marginTop"),
                o = h + e + I(this, "marginRight") + w.width,
                n = a + s + I(this, "marginBottom") + w.height,
                l = P.extend({}, m),
            ...
            "right" === p.my[0] ? l.left -= h : "center" === p.my[0] && (l.left -= h / 2), "bottom" === p.my[1] ? l.top -= a : "center" === p.my[1] && (l.top -= a / 2), l.left += c[0], l.top += c[1], i = {
                ...
                d < h && z(e + i) < d && (n.horizontal = "center"), u < a && z(s + o) < u && (n.vertical = "middle"), x(z(e), z(i)) > x(z(s), z(o)) ? n.important = "horizontal" : n.important = "vertical", p.using.call(this, t, n)
            }), r.offset(P.extend(l, {
                using: t
            }))
        })
        ...
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    r = -2 * e.offset[0];
                h < 0 ? ((s = t.left + l + i + r + e.collisionWidth - o - s) < 0 || s < z(h)) && (t.left += l + i + r) : 0 < a && (0 < (n = t.left - e.collisionPosition.marginLeft + l + i + r - n) || z(n) < a) && (t.left += l + i + r)
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    r = -2 * e.offset[1];
                h < 0 ? ((s = t.top + l + i + r + e.collisionHeight - o - s) < 0 || s < z(h)) && (t.top += l + i + r) : 0 < a && (0 < (n = t.top - e.collisionPosition.marginTop + l + i + r - n) || z(n) < a) && (t.top += l + i + r)
            }
        },
        flipfit: {
            left: function() {
                P.ui.position.flip.left.apply(this, arguments), P.ui.position.fit.left.apply(this, arguments)
            },
            top: function() {
                P.ui.position.flip.top.apply(this, arguments), P.ui.position.fit.top.apply(this, arguments)
            }
        }
    };
    var t;
    P.ui.position, P.extend(P.expr.pseudos, {
    ...
    P.ui.focusable = function(t, e) {
        var i, s, o, n, r = t.nodeName.toLowerCase();
        return "area" === r ? (s = (i = t.parentNode).name, !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && (0 < (s = P("img[usemap='#" + s + "']")).length && s.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(r) ? (o = !t.disabled) && (n = P(t).closest("fieldset")[0]) && (o = !n.disabled) : o = "a" === r && t.href || e, o && P(t).is(":visible") && function(t) {
        ...
        focusable: function(t) {
            return P.ui.focusable(t, null != P.attr(t, "tabindex"))
        }
    });
    var e, f;
    P.ui.focusable, P.fn._form = function() {
        return "string" == typeof this[0].form ? this.closest("form") : P(this[0].form)
    }, P.ui.formResetMixin = {
        ...
        _unbindFormResetHandler: function() {
            var t;
            this.form.length && ((t = this.form.data("ui-form-reset-instances")).splice(P.inArray(this, t), 1), t.length ? this.form.data("ui-form-reset-instances", t) : this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset"))
        }
    };
    P.expr.pseudos || (P.expr.pseudos = P.expr[":"]), P.uniqueSort || (P.uniqueSort = P.unique), P.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, f = function(t, e) {
        return e ? "\0" === t ? "ï¿½" : t.slice(0, -1) + "\\" + t.charCodeAt(t.length - 1).toString(16) + " " : "\\" + t
    }, P.escapeSelector = function(t) {
        return (t + "").replace(e, f)
    }), P.fn.even && P.fn.odd || P.fn.extend({
        even: function() {
    ...
    P.ui.keyCode = {
        ...
        TAB: 9,
        UP: 38
    }, P.fn.labels = function() {
        var t, e, i;
        return this.length ? this[0].labels && this[0].labels.length ? this.pushStack(this[0].labels) : (e = this.eq(0).parents("label"), (t = this.attr("id")) && (i = (i = this.eq(0).parents().last()).add((i.length ? i : this).siblings()), t = "label[for='" + P.escapeSelector(t) + "']", e = e.add(i.find(t).addBack(t))), this.pushStack(e)) : this.pushStack([])
        ...
        tabbable: function(t) {
            var e = P.attr(t, "tabindex"),
                i = null != e;
            return (!i || 0 <= e) && P.ui.focusable(t, i)
        }
    }), P.fn.extend({
    ...
    P.widget("ui.mouse", {
        ...
        _mouseDown: function(t) {
            if (!u) {
                ...
                return i && !s && this._mouseCapture(t) ? (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    e.mouseDelayMet = !0
                }, this.options.delay)), this._mouseDistanceMet(t) && this._mouseDelayMet(t) && (this._mouseStarted = !1 !== this._mouseStart(t), !this._mouseStarted) ? (t.preventDefault(), !0) : (!0 === P.data(t.target, this.widgetName + ".preventClickEvent") && P.removeData(t.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function(t) {
        ...
        _mouseUp: function(t) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && P.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, u = !1, t.preventDefault()
        },
    ...
    P.widget("ui.draggable", P.ui.mouse, {
        ...
        _mouseStop: function(t) {
            var e = this,
                i = !1;
            return P.ui.ddmanager && !this.options.dropBehaviour && (i = P.ui.ddmanager.drop(this, t)), this.dropped && (i = this.dropped, this.dropped = !1), "invalid" === this.options.revert && !i || "valid" === this.options.revert && i || !0 === this.options.revert || "function" == typeof this.options.revert && this.options.revert.call(this.element, i) ? P(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        _trigger: function(t, e, i) {
            return i = i || this._uiHash(), P.ui.plugin.call(this, t, [e, i, this], !0), /^(drag|start|stop)/.test(t) && (this.positionAbs = this._convertPositionTo("absolute"), i.offset = this.positionAbs), P.Widget.prototype._trigger.call(this, t, e, i)
        },
        plugins: {},
        _uiHash: function() {
            return {
        ...
        start: function(e, t, i) {
            ...
            i.sortables = [], P(i.options.connectToSortable).each(function() {
        ...
        stop: function(e, t, i) {
            ...
            i.cancelHelperRemoval = !1, P.each(i.sortables, function() {
                var t = this;
        ...
        drag: function(i, s, o) {
            P.each(o.sortables, function() {
                ...
                e.positionAbs = o.positionAbs, e.helperProportions = o.helperProportions, e.offset.click = o.offset.click, e._intersectsWith(e.containerCache) && (t = !0, P.each(o.sortables, function() {
                    ...
                    return s.helper[0]
                }, i.target = e.currentItem[0], e._mouseCapture(i, !0), e._mouseStart(i, !0, !0), e.offset.click.top = o.offset.click.top, e.offset.click.left = o.offset.click.left, e.offset.parent.left -= o.offset.parent.left - e.offset.parent.left, e.offset.parent.top -= o.offset.parent.top - e.offset.parent.top, o._trigger("toSortable", i), o.dropped = e.element, P.each(o.sortables, function() {
                    this.refreshPositions()
                }), o.currentItem = o.element, e.fromOutside = o), e.currentItem && (e._mouseDrag(i), s.position = e.position)) : e.isOver && (e.isOver = 0, e.cancelHelperRemoval = !0, e.options._revert = e.options.revert, e.options.revert = !1, e._trigger("out", i, e._uiHash(e)), e._mouseStop(i, !0), e.options.revert = e.options._revert, e.options.helper = e.options._helper, e.placeholder && e.placeholder.remove(), s.helper.appendTo(o._parent), o._refreshOffsets(i), s.position = o._generatePosition(i, !0), o._trigger("fromSortable", i), o.dropped = !1, P.each(o.sortables, function() {
                    this.refreshPositions()
                }))
            })
        }
        ...
        start: function(t, e, i) {
            var s = i.options;
            i.snapElements = [], P(s.snap.constructor !== String ? s.snap.items || ":data(ui-draggable)" : s.snap).each(function() {
                var t = P(this),
                    e = t.offset();
        ...
        drag: function(t, e, i) {
            ...
            }).left)), !i.snapElements[v].snapping && (s || o || n || r || p) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, P.extend(i._uiHash(), {
                snapItem: i.snapElements[v].item
        ...
        start: function(t, e, i) {
            var s, i = i.options,
                i = P.makeArray(P(i.stack)).sort(function(t, e) {
                    return (parseInt(P(t).css("zIndex"), 10) || 0) - (parseInt(P(e).css("zIndex"), 10) || 0)
                });
            i.length && (s = parseInt(P(i[0]).css("zIndex"), 10) || 0, P(i).each(function(t) {
    ...
    P.widget("ui.resizable", P.ui.mouse, {
        ...
        _hasScroll: function(t, e) {
            if ("hidden" === P(t).css("overflow")) return !1;
        ...
        _create: function() {
            var t, e = this.options,
                i = this;
            this._addClass("ui-resizable"), P.extend(this, {
                _aspectRatio: !!e.aspectRatio,
                aspectRatio: e.aspectRatio,
                originalElement: this.element,
                _proportionallyResizeElements: [],
                _helper: e.helper || e.ghost || e.animate ? e.helper || "ui-resizable-helper" : null
            }), this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) && (this.element.wrap(P("<div class='ui-wrapper'></div>").css({
                overflow: "hidden",
                ...
                zoom: 1,
                display: "block"
            })), this.originalElement.css(t), this._proportionallyResize()), this._setupHandles(), e.autoHide && P(this.element).on("mouseenter", function() {
        ...
        _destroy: function() {
            ...
            function t(t) {
                P(t).removeData("resizable").removeData("ui-resizable").off(".resizable")
            }
            var e;
        ...
        _setupHandles: function() {
            ...
            if (this.handles = n.handles || (P(".ui-resizable-handle", this.element).length ? {
                    ...
                    ne: ".ui-resizable-ne",
                    nw: ".ui-resizable-nw"
                } : "e,s,se"), this._handles = P(), this._addedHandles = P(), this.handles.constructor === String)
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; e < i.length; e++) s = "ui-resizable-" + (t = String.prototype.trim.call(i[e])), o = P("<div>"), this._addClass(o, "ui-resizable-handle " + s), o.css({
                    zIndex: n.zIndex
            ...
            this._renderAxis = function(t) {
                var e, i, s;
                for (e in t = t || this.element, this.handles) this.handles[e].constructor === String ? this.handles[e] = this.element.children(this.handles[e]).first().show() : (this.handles[e].jquery || this.handles[e].nodeType) && (this.handles[e] = P(this.handles[e]), this._on(this.handles[e], {
        ...
        _mouseCapture: function(t) {
            var e, i, s = !1;
            for (e in this.handles)(i = P(this.handles[e])[0]) !== t.target && !P.contains(i, t.target) || (s = !0);
            return !this.options.disabled && s
        },
        _mouseStart: function(t) {
            var e, i, s = this.options,
                o = this.element;
            return this.resizing = !0, this._renderProxy(), e = this._num(this.helper.css("left")), i = this._num(this.helper.css("top")), s.containment && (e += P(s.containment).scrollLeft() || 0, i += P(s.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: e,
                top: i
                ...
                left: t.pageX,
                top: t.pageY
            }, this.aspectRatio = "number" == typeof s.aspectRatio ? s.aspectRatio : this.originalSize.width / this.originalSize.height || 1, s = P(".ui-resizable-" + this.axis).css("cursor"), P("body").css("cursor", "auto" === s ? this.axis + "-resize" : s), this._addClass("ui-resizable-resizing"), this._propagate("start", t), !0
        },
        _mouseDrag: function(t) {
            var e = this.originalMousePosition,
                ...
                e = t.pageY - e.top || 0,
                i = this._change[i];
            return this._updatePrevProperties(), i && (e = i.apply(this, [t, s, e]), this._updateVirtualBoundaries(t.shiftKey), (this._aspectRatio || t.shiftKey) && (e = this._updateRatio(e, t)), e = this._respectSize(e, t), this._updateCache(e), this._propagate("resize", t), e = this._applyChanges(), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(), P.isEmptyObject(e) || (this._updatePrevProperties(), this._trigger("resize", t, this.ui()), this._applyChanges())), !1
        },
        _mouseStop: function(t) {
            this.resizing = !1;
            ...
            }, i = parseFloat(n.element.css("left")) + (n.position.left - n.originalPosition.left) || null, s = parseFloat(n.element.css("top")) + (n.position.top - n.originalPosition.top) || null, o.animate || this.element.css(P.extend(e, {
                top: s,
                left: i
            })), n.helper.height(n.size.height), n.helper.width(n.size.width), this._helper && !o.animate && this._proportionallyResize()), P("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"), this._propagate("stop", t), this._helper && this.helper.remove(), !1
        },
        ...
        _renderProxy: function() {
            var t = this.element,
                e = this.options;
            this.elementOffset = t.offset(), this._helper ? (this.helper = this.helper || P("<div></div>").css({
                overflow: "hidden"
        ...
        stop: function(e) {
            ...
            i.element.animate(P.extend(o, n && r ? {
                top: n,
                left: r
            } : {}), {
        ...
        start: function() {
            var i, s, o = P(this).resizable("instance"),
                t = o.options,
                e = o.element,
                n = t.containment,
                r = n instanceof P ? n.get(0) : /parent/.test(n) ? e.parent().get(0) : n;
            r && (o.containerElement = P(r), /document/.test(n) || n === document ? (o.containerOffset = {
                left: 0,
                top: 0
            }, o.containerPosition = {
                left: 0,
            ...
            }) : (i = P(r), s = [], P(["Top", "Right", "Left", "Bottom"]).each(function(t, e) {
        ...
        start: function() {
            ...
            t.ghost = t.originalElement.clone(), t.ghost.css({
                ...
                left: 0,
                top: 0
            }), t._addClass(t.ghost, "ui-resizable-ghost"), !1 !== P.uiBackCompat && "string" == typeof t.options.ghost && t.ghost.addClass(this.options.ghost), t.ghost.appendTo(t.helper)
        },
        resize: function() {
            var t = P(this).resizable("instance");
            t.ghost && t.ghost.css({
        ...
        resize: function() {
            var t, e = P(this).resizable("instance"),
                i = e.options,
                s = e.size,
                o = e.originalSize,
                n = e.originalPosition,
    ...
    P.ui.resizable, P.widget("ui.sortable", P.ui.mouse, {
        version: "1.13.2",
        ...
        _mouseCapture: function(t, e) {
            var i = null,
                s = !1,
                o = this;
            return !this.reverting && (!this.options.disabled && "static" !== this.options.type && (this._refreshItems(t), P(t.target).parents().each(function() {
                if (P.data(this, o.widgetName + "-item") === o) return i = P(this), !1
        ...
        _mouseStart: function(t, e, i) {
            ...
            if ((this.currentContainer = this).refreshPositions(), this.appendTo = P("parent" !== n.appendTo ? n.appendTo : this.currentItem.parent()), this.helper = this._createHelper(t), this._cacheHelperProportions(), this._cacheMargins(), this.offset = this.currentItem.offset(), this.offset = {
                ...
                }, this.helper[0] !== this.currentItem[0] && this.currentItem.hide(), this._createPlaceholder(), this.scrollParent = this.placeholder.scrollParent(), P.extend(this.offset, {
                    parent: this._getParentOffset()
        ...
        _mouseDrag: function(t) {
            ...
            for (this.position = this._generatePosition(t), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), n.scroll && !1 !== this._scroll(t) && (this._refreshItemPositions(!0), P.ui.ddmanager && !n.dropBehaviour && P.ui.ddmanager.prepareOffsets(this, t)), this.dragDirection = {
                    vertical: this._getDragVerticalDirection(),
                    horizontal: this._getDragHorizontalDirection()
                }, e = this.items.length - 1; 0 <= e; e--)
                if (s = (i = this.items[e]).item[0], (o = this._intersectsWithPointer(i)) && i.instance === this.currentContainer && !(s === this.currentItem[0] || this.placeholder[1 === o ? "next" : "prev"]()[0] === s || P.contains(this.placeholder[0], s) || "semi-dynamic" === this.options.type && P.contains(this.element[0], s))) {
        ...
        _mouseStop: function(t, e) {
            var i, s, o, n;
            if (t) return P.ui.ddmanager && !this.options.dropBehaviour && P.ui.ddmanager.drop(this, t), this.options.revert ? (s = (i = this).placeholder.offset(), n = {}, (o = this.options.axis) && "x" !== o || (n.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft)), o && "y" !== o || (n.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)), this.reverting = !0, P(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function() {
                i._clear(t)
            })) : this._clear(t, e), !1
        },
        cancel: function() {
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (h && t)
                for (e = h.length - 1; 0 <= e; e--)
                    for (i = (s = P(h[e], this.document[0])).length - 1; 0 <= i; i--)(o = P.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && r.push(["function" == typeof o.options.items ? o.options.items.call(o.element) : P(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
            ...
            for (r.push(["function" == typeof this.options.items ? this.options.items.call(this.element, null, {
                ...
                }) : P(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), e = r.length - 1; 0 <= e; e--) r[e][0].each(a);
            return P(n)
        },
        ...
        _refreshItems: function(t) {
            ...
            if (p && this.ready)
                for (e = p.length - 1; 0 <= e; e--)
                    for (i = (s = P(p[e], this.document[0])).length - 1; 0 <= i; i--)(o = P.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && (c.push(["function" == typeof o.options.items ? o.options.items.call(o.element[0], t, {
                        item: this.currentItem
                    }) : P(o.options.items, o.element), o]), this.containers.push(o));
            for (e = c.length - 1; 0 <= e; e--)
                for (n = c[e][1], a = (r = c[e][i = 0]).length; i < a; i++)(h = P(r[i])).data(this.widgetName + "-item", n), l.push({
                    item: h,
                    instance: n,
                    width: 0,
                    height: 0,
        ...
        _refreshItemPositions: function(t) {
            for (var e, i, s = this.items.length - 1; 0 <= s; s--) e = this.items[s], this.currentContainer && e.instance !== this.currentContainer && e.item[0] !== this.currentItem[0] || (i = this.options.toleranceElement ? P(this.options.toleranceElement, e.item) : e.item, t || (e.width = i.outerWidth(), e.height = i.outerHeight()), i = i.offset(), e.left = i.left, e.top = i.top)
        },
        ...
        _createPlaceholder: function(i) {
            ...
            }), i.placeholder = P(n.placeholder.element.call(i.element, i.currentItem)), i.currentItem.after(i.placeholder), n.placeholder.update(i, i.placeholder)
        },
        ...
        _contactContainers: function(t) {
            ...
            if (c)
                if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1);
                    ...
                    for (i = 1e4, s = null, o = (a = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", n = a ? "width" : "height", l = a ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) P.contains(this.containers[p].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (r = this.items[e].item.offset()[o], h = !1, t[l] - r > this.items[e][n] / 2 && (h = !0), Math.abs(t[l] - r) < i && (i = Math.abs(t[l] - r), s = this.items[e], this.direction = h ? "up" : "down"));
        ...
        _createHelper: function(t) {
            var e = this.options,
                t = "function" == typeof e.helper ? P(e.helper.apply(this.element[0], [t, this.currentItem])) : "clone" === e.helper ? this.currentItem.clone() : this.currentItem;
        ...
        _getParentOffset: function() {
            ...
            var t = this.offsetParent.offset();
            return "absolute" === this.cssPosition && this.scrollParent[0] !== this.document[0] && P.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(), t.top += this.scrollParent.scrollTop()), {
    ...
    P.widget("ui.tooltip", {
        ...
        _removeDescribedBy: function(t) {
            var e = t.data("ui-tooltip-id"),
                ...
                e = P.inArray(e, i); - 1 !== e && i.splice(e, 1), t.removeData("ui-tooltip-id"), (i = String.prototype.trim.call(i.join(" "))) ? t.attr("aria-describedby", i) : t.removeAttr("aria-describedby")
        },
        _create: function() {
            this._on({
                mouseover: "open",
                focusin: "open"
            }), this.tooltips = {}, this.parents = {}, this.liveRegion = P("<div>").attr({
                role: "log",
                "aria-live": "assertive",
                "aria-relevant": "additions"
            }).appendTo(this.document[0].body), this._addClass(this.liveRegion, null, "ui-helper-hidden-accessible"), this.disabledTitles = P([])
        },
        _setOption: function(t, e) {
            var i = this;
            this._super(t, e), "content" === t && P.each(this.tooltips, function(t, e) {
        ...
        _disable: function() {
            var s = this;
            P.each(this.tooltips, function(t, e) {
                var i = P.Event("blur");
        ...
        _enable: function() {
            ...
            }), this.disabledTitles = P([])
        },
        open: function(t) {
            var i = this,
                e = P(t ? t.target : this.element).closest(this.options.items);
            e.length && !e.data("ui-tooltip-id") && (e.attr("title") && e.data("ui-tooltip-title", e.attr("title")), e.data("ui-tooltip-open", !0), t && "mouseover" === t.type && e.parents().each(function() {
                var t, e = P(this);
                e.data("ui-tooltip-open") && ((t = P.Event("blur")).target = t.currentTarget = this, i.close(t, !0)), e.attr("title") && (e.uniqueId(), i.parents[this.id] = {
                    element: this,
                    title: e.attr("title")
                }, e.attr("title", ""))
        ...
        _open: function(t, e, i) {
            var s, o, n, r = P.extend({}, this.options.position);
            ...
            i && ((s = this._find(e)) ? s.tooltip.find(".ui-tooltip-content").html(i) : (e.is("[title]") && (t && "mouseover" === t.type ? e.attr("title", "") : e.removeAttr("title")), s = this._tooltip(e), o = s.tooltip, this._addDescribedBy(e, o.attr("id")), o.find(".ui-tooltip-content").html(i), this.liveRegion.children().hide(), (i = P("<div>").html(o.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), i.removeAttr("id").find("[id]").removeAttr("id"), i.appendTo(this.liveRegion), this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, {
                ...
                o.is(":visible") && (h(r.of), clearInterval(n))
        ...
        _registerCloseHandlers: function(t, e) {
            var i = {
                keyup: function(t) {
                    t.keyCode === P.ui.keyCode.ESCAPE && ((t = P.Event(t)).currentTarget = e[0], this.close(t, !0))
                }
            };
        ...
        close: function(t) {
            var e, i = this,
                s = P(t ? t.currentTarget : this.element),
                o = this._find(s);
            o ? (e = o.tooltip, o.closing || (clearInterval(this.delayedShow), s.data("ui-tooltip-title") && !s.attr("title") && s.attr("title", s.data("ui-tooltip-title")), this._removeDescribedBy(s), o.hiding = !0, e.stop(!0), this._hide(e, this.options.hide, function() {
                i._removeTooltip(P(this))
            }), s.removeData("ui-tooltip-open"), this._off(s, "mouseleave focusout keyup"), s[0] !== this.element[0] && this._off(s, "remove"), this._off(this.document, "mousemove"), t && "mouseleave" === t.type && P.each(this.parents, function(t, e) {
                P(e.element).attr("title", e.title), delete i.parents[t]
            }), o.closing = !0, this._trigger("close", t, {
                tooltip: e
            }), o.hiding || (o.closing = !1))) : s.removeData("ui-tooltip-open")
        },
        _tooltip: function(t) {
            var e = P("<div>").attr("role", "tooltip"),
                i = P("<div>").appendTo(e),
        ...
        _destroy: function() {
            ...
            P.each(this.tooltips, function(t, e) {
                var i = P.Event("blur"),
                    e = e.element;
                i.target = i.currentTarget = e[0], s.close(i, !0), P("#" + t).remove(), e.data("ui-tooltip-title") && (e.attr("title") || e.attr("title", e.data("ui-tooltip-title")), e.removeData("ui-tooltip-title"))
            }), this.liveRegion.remove()
        }
    }), !1 !== P.uiBackCompat && P.widget("ui.tooltip", P.ui.tooltip, {
        options: {
            tooltipClass: null
        },
        _tooltip: function() {
